...
namespace HesabrasYar.Wallet.Migrations
{
    ...
    [Migration("20260718091153_Wallet_AsyncBalanceInitialization")]
    partial class Wallet_AsyncBalanceInitialization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HesabrasYar.Wallet.Wallets.Transaction", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("HesabrasYar.Wallet.Wallets.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Code"), 10001L);
            ...
            modelBuilder.Entity("HesabrasYar.Wallet.Wallets.WalletBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppWalletBalances", (string)null);
                });
            ...
            modelBuilder.Entity("HesabrasYar.Wallet.Wallets.Transaction", b =>
                {
                    b.HasOne("HesabrasYar.Wallet.Wallets.Wallet", null)
            ...
            modelBuilder.Entity("HesabrasYar.Wallet.Wallets.WalletBalance", b =>
                {
                    b.HasOne("HesabrasYar.Wallet.Wallets.Wallet", null)
                        .WithOne("Balance")
                        .HasForeignKey("HesabrasYar.Wallet.Wallets.WalletBalance", "WalletId")
